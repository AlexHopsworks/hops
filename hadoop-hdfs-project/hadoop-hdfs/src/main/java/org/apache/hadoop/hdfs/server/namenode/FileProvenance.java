...
public class FileProvenance {
  ...
  private static void log(long namenodeId, INode inode, TrackedProv type, INodeDirectory[] parents,
    ...
    String p3Name = parents[ProvParents.PARENT_P3.ordinal()] != null
      ? parents[ProvParents.PARENT_P3.ordinal()].getLocalName() : "";
    Long p3Id = parents[ProvParents.PARENT_P3.ordinal()] != null
      ? parents[ProvParents.PARENT_P3.ordinal()].getId() : -1;
    String p4Name = parents[ProvParents.PARENT_P4.ordinal()] != null
      ? parents[ProvParents.PARENT_P4.ordinal()].getLocalName() : "";
    Long p4Id = parents[ProvParents.PARENT_P4.ordinal()] != null
      ? parents[ProvParents.PARENT_P4.ordinal()].getId() : -1;
    ...
    FileProvenanceEntry ple = new FileProvenanceEntry(inode.getId(), op, inode.getLogicalTime(), timestamp,
      ...
      parents[ProvParents.PARENT_DIRECT.ordinal()].getLocalName(),
  ...
  static Pair<TrackedProv, INodeDirectory[]> provenanceDirs(INode inode)
    ...
    if (PROV_PROJECTS.equals(aux.getLast().getLocalName())) { //part of a project - path - /Projects/
      ...
      if (aux.isEmpty()) { //dataset
        ...
        provDirs[ProvParents.PARENT_P3.ordinal()] = aux.isEmpty() ? null : aux.removeLast();
        provDirs[ProvParents.PARENT_P4.ordinal()] = aux.isEmpty() ? null : aux.removeLast();
        return new Pair<>(TrackedProv.DATASET, provDirs);
      }
