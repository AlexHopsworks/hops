...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final String DFS_NAMENODE_PROCESS_MISREPLICATED_NO_OF_THREADS = "dfs.namenode.misreplicated.noofthreads";
  public static final int DFS_NAMENODE_PROCESS_MISREPLICATED_NO_OF_THREADS_DEFAULT = 20;
  public static final String DFS_NAMENODE_REMOVAL_BATCH_SIZE = "dfs.namenode.removal.batchsize";
  public static final int DFS_NAMENODE_REMOVAL_BATCH_SIZE_DEFAULT = 500;
  public static final String DFS_NAMENODE_REMOVAL_NO_OF_THREADS = "dfs.namenode.removal.noofbatches";
  public static final int DFS_NAMENODE_REMOVAL_NO_OF_THREADS_DEFAULT = 20;
  ...
  public static final int     DFS_NAMENODE_MAX_XATTR_SIZE_DEFAULT = XAttrStorage.getMaxXAttrSize();
